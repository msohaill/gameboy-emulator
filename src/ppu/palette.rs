...
pub const PALETTE: [Color; 0x40] = [
   ...
   Color(0x18, 0x38, 0x58), Color(0x00, 0x00, 0x00), Color(0x00, 0x00, 0x00), Color(0x0E, 0x0E, 0x16),
   ...
   Color(0x00, 0x80, 0x88), Color(0x00, 0x00, 0x00), Color(0x00, 0x00, 0x00), Color(0x00, 0x00, 0x00),
   ...
   Color(0x00, 0xE8, 0xD8), Color(0x50, 0x50, 0x50), Color(0x00, 0x00, 0x00), Color(0x00, 0x00, 0x00),
   ...
   Color(0x98, 0xF8, 0xF0), Color(0x98, 0x98, 0x98), Color(0x00, 0x00, 0x00), Color(0x00, 0x00, 0x00)
];
